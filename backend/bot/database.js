...
function saveGallery(gallery) {
  ...
  if (existingIndex > -1) {
    ...
    const updated = {
      ...
      guestCode: gallery.guestCode !== undefined ? gallery.guestCode : (existing.guestCode || ""),
      loginMode: gallery.loginMode || existing.loginMode || "single",
    ...
    const newGallery = {
      ...
      loginMode: gallery.loginMode || "three_tier_split",
